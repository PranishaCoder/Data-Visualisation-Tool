...
public class AreaChartApp extends Application {
    ...
    public void start(Stage primaryStage) {
        primaryStage.setTitle("AREA CHART GENERATOR");

        Label label = new Label("Enter data for the area chart:");
        ...
        addButton.setStyle("-fx-font-size: 14px; -fx-background-color: #5D3FD3; -fx-text-fill: white;");
        ...
        VBox root = new VBox(10, label, inputs, buttons, tableView, areaChart);
